...
utils.add_folder_path_and_extensions("sams", [os.path.join(model_path, "sams"), os.path.join(folder_paths.cache_dir, "models/sams")], folder_paths.supported_pt_extensions)
utils.add_folder_path_and_extensions("onnx", [os.path.join(model_path, "onnx"), os.path.join(folder_paths.cache_dir, "models/onnx")], {'.onnx'})
utils.add_folder_path_and_extensions("mmdets_bbox", [os.path.join(model_path, "mmdets", "bbox"), os.path.join(folder_paths.cache_dir, "models/bbox")], folder_paths.supported_pt_extensions)
utils.add_folder_path_and_extensions("mmdets_segm", [os.path.join(model_path, "mmdets", "segm"), os.path.join(folder_paths.cache_dir, "models/mmdets/segm")], folder_paths.supported_pt_extensions)
utils.add_folder_path_and_extensions("mmdets", [os.path.join(model_path, "mmdets"), os.path.join(folder_paths.cache_dir, "models/mmdets")], folder_paths.supported_pt_extensions)
